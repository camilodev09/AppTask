...
const Category = () => {
  ...
  return (
    <div className="w-full lgl:w-[850px] h-[200px] md:h-[150px] bg-bodyColor flex flex-col md:flex-row items-center justify-start rounded-xl ">
      <div className="w-full md:w-1/6 h-full rounded-xl  p-3  ">
        <button
          onClick={() =>
      ...
      <div className="w-full md:w-5/6 h-full flex items-center overflow-y-scroll scrollbar-hide">
        ...
        >
          {" "}
          Click on the tab to choose your task category
        </p>
